...
<modal ref="mo_create_per" no-close-on-backdrop title="Agregar Proveedor" width="900px" @ok="create_usr" @cancel="closecrear" cancel-title="Atras" centered>
  <el-form  ref="form_cref" :rules="rules" :model="form_c" label-width="150px" >
    ...
    <el-form-item label="Fecha de viaje">
      <el-row style="width: 800px">
        ...
        <el-col :span="18">
          <el-select v-model="form_c.via_id" placeholder="Seleccione una opcion" style="width: 100%" clearable>
            <el-option
    ...
    <el-row>
      <el-col :span="12">
        ...
        <el-form-item label="Serie" prop="rs">
          <el-input />
        </el-form-item>
        <el-form-item label="Numero" prop="rs">
          <el-input />
        </el-form-item>
        <el-form-item label="Fecha emision" prop="rs">
          <el-date-picker
            type="date"
            v-model="form_c.fecha_via"
            format="YYYY-MM-DD"
        ...
        <el-form-item label="Peso" prop="rs">
          <el-input />
        </el-form-item>
      </el-col>
