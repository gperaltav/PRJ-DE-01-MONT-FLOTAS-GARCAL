...
<div class="main-container">
  <h1 style="text-align:center;padding-right:200px; color:red; size">
    No se supone que deban estar aquí
  </h1>
  ...
  <div class="table-container">
    ...
    <el-table scrollbar-always-on :cell-class-name="cellStyle2" :data="datap" border header-row-style="color:black;"  >
      ...
      <el-table-column label="Licencia A4" width="3000">
        <template #default="scope">
      ...
      <el-table-column label="Rev. Medica" width="3000">
        <template #default="scope">
...
<modal ref="mo_editar_per" no-close-on-backdrop title="Detalles" width="500px" @ok="send_editar_doc" cancel-title="Atrás" @cancel="closeedit"  centered>
  <el-form @submit.prevent -loading="wait" ref="form_edit_ref" :rules="rules" :model="form" label-width="150px" >
...
<style>
  ...
  .table-container .el-scrollbar__thumb {
    background:#343434;
    
  }

  .table-container .el-scrollbar__bar.is-horizontal {
    bottom: 3px;
    height: 12px;
    opacity: 70%;
  }
  .table-container .el-scrollbar__bar.is-vertical {
    right: 3px;
    width: 12px;
    opacity: 50%;
  }

  /* .el-scrollbar_thumb .is-horizontal {
    height: 50px;
  } */
  .el-table .cell-1 {
    background: #92d36e;
